...
const documents = {
    ...
    "query Posts($cursor: Cursor, $forFeeds: [EvmAddress!], $filter: PostsFilter) {\n  posts(request: {\n    cursor: $cursor\n    forFeeds: $forFeeds\n    filter: $filter\n  }) {\n    items {\n      ... on Post {\n        id\n        author {\n          address\n          metadata {\n            id\n            coverPicture\n            name\n          }\n          username {\n            localName\n            namespace {\n              namespace\n            }\n          }\n        }\n        timestamp\n        metadata {\n          ... on TextOnlyMetadata {\n            id\n            content\n            locale\n          }\n        }\n        stats {\n          reactions\n          comments\n          collects\n          bookmarks\n          quotes\n          reposts\n        }\n      }\n    }\n    pageInfo {\n      next\n      prev\n    }\n  }\n}": types.PostsDocument,
    "query AccountsAvailable($managedBy: EvmAddress!) {\n  accountsAvailable(request: {\n    managedBy: $managedBy\n  }) {\n    items {\n      ... on AccountOwned {\n        account {\n          address\n          metadata {\n            name\n            id\n          }\n          username {\n            localName\n            namespace {\n              namespace\n              address\n            }\n          }\n        }\n      }\n    }\n  }\n}": types.AccountsAvailableDocument,
};
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateAppMutation(\n$metadataUri: URI!\n$namespace: EvmAddress!\n$admins: [EvmAddress!]\n) {\n  createApp(request: {\n    metadataUri: $metadataUri\n    namespace: $namespace\n    admins: $admins\n  }) {\n    ... on CreateAppResponse {\n      hash\n    }\n  }\n}"): (typeof documents)["mutation CreateAppMutation(\n$metadataUri: URI!\n$namespace: EvmAddress!\n$admins: [EvmAddress!]\n) {\n  createApp(request: {\n    metadataUri: $metadataUri\n    namespace: $namespace\n    admins: $admins\n  }) {\n    ... on CreateAppResponse {\n      hash\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation SetAppNamespace(\n$usernameNamespace: EvmAddress!\n$app: EvmAddress!\n) {\n  setAppUsernameNamespace(request: {\n    usernameNamespace: $usernameNamespace\n    app: $app\n  }) {\n... on SponsoredTransactionRequest {\n      reason\n      sponsoredReason\n      raw {\n        nonce\n        to\n        from\n        data\n        type\n        value\n        gasLimit\n        maxFeePerGas\n        maxPriorityFeePerGas\n        customData {\n          customSignature\n          factoryDeps\n          gasPerPubdata\n          paymasterParams {\n            paymaster\n            paymasterInput\n          }\n        }\n        chainId\n      }\n    }\n    ... on TransactionWillFail {\n      reason\n    }\n    ... on SelfFundedTransactionRequest {\n      raw {\n        type\n        to\n        from\n        nonce\n        gasLimit\n        maxPriorityFeePerGas\n        maxFeePerGas\n        data\n        value\n        chainId\n      }\n      reason\n      selfFundedReason\n    }\n  }\n}"): (typeof documents)["mutation SetAppNamespace(\n$usernameNamespace: EvmAddress!\n$app: EvmAddress!\n) {\n  setAppUsernameNamespace(request: {\n    usernameNamespace: $usernameNamespace\n    app: $app\n  }) {\n... on SponsoredTransactionRequest {\n      reason\n      sponsoredReason\n      raw {\n        nonce\n        to\n        from\n        data\n        type\n        value\n        gasLimit\n        maxFeePerGas\n        maxPriorityFeePerGas\n        customData {\n          customSignature\n          factoryDeps\n          gasPerPubdata\n          paymasterParams {\n            paymaster\n            paymasterInput\n          }\n        }\n        chainId\n      }\n    }\n    ... on TransactionWillFail {\n      reason\n    }\n    ... on SelfFundedTransactionRequest {\n      raw {\n        type\n        to\n        from\n        nonce\n        gasLimit\n        maxPriorityFeePerGas\n        maxFeePerGas\n        data\n        value\n        chainId\n      }\n      reason\n      selfFundedReason\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateUsernameNamespace(\n  $metadataUri: URI!\n  $namespace: String!\n  $symbol: String!\n  $admins: [EvmAddress!]\n) {\n  createUsernameNamespace(\n    request: {\n      metadataUri: $metadataUri\n      namespace: $namespace\n      symbol: $symbol\n      admins: $admins\n    }\n  ) {\n    ... on CreateNamespaceResponse {\n      hash\n    }\n\n    ... on TransactionWillFail {\n      reason\n    }\n  }\n}\n"): (typeof documents)["mutation CreateUsernameNamespace(\n  $metadataUri: URI!\n  $namespace: String!\n  $symbol: String!\n  $admins: [EvmAddress!]\n) {\n  createUsernameNamespace(\n    request: {\n      metadataUri: $metadataUri\n      namespace: $namespace\n      symbol: $symbol\n      admins: $admins\n    }\n  ) {\n    ... on CreateNamespaceResponse {\n      hash\n    }\n\n    ... on TransactionWillFail {\n      reason\n    }\n  }\n}\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateAccountWithUsername(\n  $localName: String!\n  $metadataUri: URI!\n  $owner: EvmAddress!\n  $namespace: EvmAddress!\n) {\n  createAccountWithUsername(\n    request: {\n      username: {\n        localName: $localName\n        namespace: $namespace\n      }\n      metadataUri: $metadataUri\n      accountManager: [$owner]\n    }\n  ) {\n    ... on CreateAccountResponse {\n      hash\n    }\n\n    ... on InvalidUsername {\n      reason\n    }\n\n    ... on TransactionWillFail {\n      reason\n    }\n  }\n}"): (typeof documents)["mutation CreateAccountWithUsername(\n  $localName: String!\n  $metadataUri: URI!\n  $owner: EvmAddress!\n  $namespace: EvmAddress!\n) {\n  createAccountWithUsername(\n    request: {\n      username: {\n        localName: $localName\n        namespace: $namespace\n      }\n      metadataUri: $metadataUri\n      accountManager: [$owner]\n    }\n  ) {\n    ... on CreateAccountResponse {\n      hash\n    }\n\n    ... on InvalidUsername {\n      reason\n    }\n\n    ... on TransactionWillFail {\n      reason\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query Posts($cursor: Cursor, $forFeeds: [EvmAddress!], $filter: PostsFilter) {\n  posts(request: {\n    cursor: $cursor\n    forFeeds: $forFeeds\n    filter: $filter\n  }) {\n    items {\n      ... on Post {\n        id\n        author {\n          address\n          metadata {\n            id\n            coverPicture\n            name\n          }\n          username {\n            localName\n            namespace {\n              namespace\n            }\n          }\n        }\n        timestamp\n        metadata {\n          ... on TextOnlyMetadata {\n            id\n            content\n            locale\n          }\n        }\n        stats {\n          reactions\n          comments\n          collects\n          bookmarks\n          quotes\n          reposts\n        }\n      }\n    }\n    pageInfo {\n      next\n      prev\n    }\n  }\n}"): (typeof documents)["query Posts($cursor: Cursor, $forFeeds: [EvmAddress!], $filter: PostsFilter) {\n  posts(request: {\n    cursor: $cursor\n    forFeeds: $forFeeds\n    filter: $filter\n  }) {\n    items {\n      ... on Post {\n        id\n        author {\n          address\n          metadata {\n            id\n            coverPicture\n            name\n          }\n          username {\n            localName\n            namespace {\n              namespace\n            }\n          }\n        }\n        timestamp\n        metadata {\n          ... on TextOnlyMetadata {\n            id\n            content\n            locale\n          }\n        }\n        stats {\n          reactions\n          comments\n          collects\n          bookmarks\n          quotes\n          reposts\n        }\n      }\n    }\n    pageInfo {\n      next\n      prev\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query AccountsAvailable($managedBy: EvmAddress!) {\n  accountsAvailable(request: {\n    managedBy: $managedBy\n  }) {\n    items {\n      ... on AccountOwned {\n        account {\n          address\n          metadata {\n            name\n            id\n          }\n          username {\n            localName\n            namespace {\n              namespace\n              address\n            }\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query AccountsAvailable($managedBy: EvmAddress!) {\n  accountsAvailable(request: {\n    managedBy: $managedBy\n  }) {\n    items {\n      ... on AccountOwned {\n        account {\n          address\n          metadata {\n            name\n            id\n          }\n          username {\n            localName\n            namespace {\n              namespace\n              address\n            }\n          }\n        }\n      }\n    }\n  }\n}"];
